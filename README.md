...
Execute commands
    ...
    curl -O https://raw.githubusercontent.com/brianwong1861/openvpn-web-ui/master/docs/docker-compose.yml
    docker-compose up -d
...
Execute commands:
    ...
    go get github.com/brianwong1861/openvpn-web-ui
    cd $GOPATH/src/github.com/brianwong1861/openvpn-web-ui
    bee run -gendoc=true
